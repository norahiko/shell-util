...
exports.glob = function glob(env, pattern, cwd) {
    var patterns = [];
    cwd = cwd ? expand.expand(env, cwd) : "";
    ...
    for(i = 0; i < patterns.length; i++) {
        var ptn = patterns[i];
        if(/[[{?*]/.test(ptn)) {
            var matched = globy.glob(ptn, { dot: true, cwd: cwd });
...
exports.remove = function(files, removeDir) {
